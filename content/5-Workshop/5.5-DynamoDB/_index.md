...
![endpoint diagram](/images/5-Workshop/5.5-DynamoDB/s3-bucket-policy.png)
...
```
![test](/images/5-Workshop/5.5-DynamoDB/test1.png)
...
![create bucket](/images/5-Workshop/5.5-DynamoDB/create-bucket.png)

Successfully create bucket

![Success](/images/5-Workshop/5.5-DynamoDB/create-bucket-success.png)
...
![policy](/images/5-Workshop/5.5-DynamoDB/policy1.png)
...
![custom policy](/images/5-Workshop/5.5-DynamoDB/policy2.png)

Successfully customize policy

![success](/images/5-Workshop/5.5-DynamoDB/success.png)
...
![error](/images/5-Workshop/5.5-DynamoDB/error.png)
...
![success](/images/5-Workshop/5.5-DynamoDB/test2.png)

This operation succeeds because it is permitted by the VPC endpoint policy.

![success](/images/5-Workshop/5.5-DynamoDB/test2-success.png)
...
![fail](/images/5-Workshop/5.5-DynamoDB/test2-fail.png)
