...
![endpoint](/images/5-Workshop/5.3-S3-setup/endpoints.png)

3. In the Create endpoint console:
+ Specify name of the endpoint: ```s3-gwe```
+ In service category, choose **AWS services**

![endpoint](/images/5-Workshop/5.3-S3-setup/create-s3-gwe1.png)

+ In **Services**, type ```s3``` in the search box and choose the service with type **gateway**

![endpoint](/images/5-Workshop/5.3-S3-setup/services.png)
...
![endpoint](/images/5-Workshop/5.3-S3-setup/vpc.png)
...
![endpoint](/images/5-Workshop/5.3-S3-setup/policy.png)
...
![endpoint](/images/5-Workshop/5.3-S3-setup/complete.png)
